...
from prepro import wiki_data_builder
...
if __name__ == '__main__':
    ...
    parser.add_argument("-base_LM", default='bert-base', type=str,
                        choices=['bert-base', 'bert-large', 'xlm-roberta-base', 'xlm-roberta-longformer-base-4096',
                                 'xlm-roberta-longformer-large-4096', 'bigbird-pegasus-large-arxiv',
    ...
    if args.dataset:
        eval('wiki_data_builder.' + args.mode + '(args)')
